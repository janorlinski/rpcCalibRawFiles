...
Int_t analysisDST(TString inFile, TString outFile, Int_t nEvents=20000, Int_t startEvt=0)
{
    ...
    TString asciiParFile     = "./params/Start2CalPar_mod0_mod1_veto_fixTwoCh_JanOrlinski_15042024.txt";  // HMdcDeDx2 + HMdcDeDx2Scale
	...
	asciiParFile = "./params/feb24_dst_params_cc_calTime0again_testRpc_12032024.txt";
    ...
    TString rootParFile      = "./params/allParam_feb24_gen0_15042024.root";  // oracle no HMdcDeDx2Scale
    ...
    */
    ...
    ChargeCalibrationRPC* ChargeCalibrationRPCTask = new ChargeCalibrationRPC("qcalibrpc", "qcalibrpc", out);
    TimeAndPosCalibrationRPC* TimeAndPosCalibrationRPCTask = new TimeAndPosCalibrationRPC("tcalibrpc", "tcalibrpc", out);
    StartCalibration* StartCalibrationTask = new StartCalibration("startcalib", "startcalib", out);
    
    masterTaskSet->add(TimeAndPosCalibrationRPCTask);	
    masterTaskSet->add(ChargeCalibrationRPCTask);	
